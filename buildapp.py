...
cmd_str = './build.py --package org.broadinstitute.ebolacare --name "Ebola CARE" --version 0.5 --dir ' + app_dir + ' --orientation "sensor" --icon ' + icon_file + ' --presplash ' + load_file + ' ' + build_options
os.system(cmd_str)
os.chdir(curr_dir)
